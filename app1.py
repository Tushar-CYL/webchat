...
client = MongoClient(
    "mongodb+srv://tusharkanti:993355%40Tushar@cluster0.w5gny.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
    tls=True,
...
class RealTimeChatApp:
    ...
    def mark_messages_as_read(self, other_user):
        try:
            ...
            st.error(f"Error marking messages as read: {str(e)}")
